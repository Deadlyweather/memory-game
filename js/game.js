import { createBoard, SetTheme } from './board.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById("btn-fruits").addEventListener("click", () => SetTheme("Fruits"));
    document.getElementById("btn-fantasy").addEventListener("click", () => SetTheme("Fantasy"));
